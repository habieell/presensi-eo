...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div
        className="absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-brand-600/10 blur-3xl animate-float"
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-neutral-400 font-medium">
            Sistem Presensi & Manajemen Modern
          </p>
        </div>
        ...
        <div className="glass-card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-xs font-semibold text-neutral-300 uppercase tracking-wider mb-1.5 block">
                Email
              </label>
              <input
                type="email"
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                >
                  <RefreshCcw
                    className={`h-4 w-4 ${refreshingCaptcha ? "animate-spin" : ""}`}
                  />
                </button>
              </div>
              <input
